...
export default function MessagePage() {
  ...
  // ✅ 3s polling to refresh messages
  useEffect(() => {
    if (!chat || !token || error) return
    ...
    <div className="max-w-2xl mx-auto px-4 py-2 h-screen flex flex-col">
      ...
      <div className="flex items-center gap-3 py-3 border-b dark:border-gray-700">
        ...
        <h2
          ...
          className="text-md font-semibold dark:text-white cursor-pointer hover:underline"
        >
          @{chat.userName}
        </h2>
      </div>
