  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-10 space-y-10">
      <div className="space-y-1">
        ...
        <p className="text-muted-foreground text-sm cursor-pointer hover:underline">
          {card.companyName} · Posted by <button onClick={() => router.push(`/publicprofile/${card.username}`)}><span className="text-blue-600">@{card.username}</button></span>
        </p>
      </div>
