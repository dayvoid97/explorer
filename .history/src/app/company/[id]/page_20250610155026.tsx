      ...
      <div className="space-y-6">
        {card.items.map((item, idx) => (
          ...
          >
            ...
            {item.signedUrl && item.mimeType?.startsWith('video/') && (
              <video controls className="w-full rounded-md border max-h-[500px] object-contain">
                <source src={item.signedUrl} type="video/quicktime" />
        ...
        {/* ✅ Optional: insert another ad after content list */}
        <AdBlock />
      </div>
    </div>
  )
