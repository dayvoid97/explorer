...
export default function PostWinForm() {
  ...
  const [postType, setPostType] = useState<'dub' | 'news'>('dub')
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-4 items-center">
        <span className="text-sm font-semibold text-gray-700 dark:text-gray-300">ISSA</span>
        <button
          type="button"
      ...
      <input
        ...
        placeholder="Add your link type shi..."
        className="w-full px-4 py-2 rounded-md bg-gray-50 dark:bg-gray-800 border text-gray-900 dark:text-gray-200"
      />
