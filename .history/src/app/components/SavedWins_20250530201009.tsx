    ...
    <section className="mb-12">
      ...
      >
        {wins.map((win) => (
          <div
            key={win.id}
            className="relative px-6 py-4 bg-white dark:bg-gray-800 rounded-xl shadow-md transition hover:shadow-lg"
          >
            <button
              onClick={async (e) => {
                e.stopPropagation()
              ...
              className="absolute top-2 right-2 bg-red-500 text-white text-xs px-3 py-1 rounded hover:bg-red-600"
            >
              Remove
            </button>
