    ...
    >
      ...
      {/* <div className="space-y-2">
        ...
        <div className="group relative w-fit">
          <label
            htmlFor="imageUpload"
            className="cursor-pointer inline-flex items-center space-x-2 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 text-white px-4 py-2 rounded-xl hover:scale-105 transition-transform shadow-md"
          >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
            {mediaFiles.map((file, i) => {
              ...
              return (
                <div
                  key={i}
                  className="relative border rounded-xl overflow-hidden shadow-md p-2 bg-gray-50 dark:bg-gray-800"
                >
