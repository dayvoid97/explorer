    ...
    >
      ...
      <div className="flex gap-4 items-start">
        ...
        <div className="flex flex-1 items-start gap-4">
          ...
          {/* Media Preview */}
          {win.previewImageUrl && (
            <div className="w-24 sm:w-28 md:w-32 flex-shrink-0 rounded-md overflow-hidden bg-gray-200 dark:bg-gray-700 flex items-center justify-center h-24 md:h-28">
              {isVideo ? (
                <video
