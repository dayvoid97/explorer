...
export default function CommentSection({ winId }: { winId: string }) {
  ...
  return (
    <div className="mt-12 space-y-8 bg-[#bdbdc0]">
      {/* Header */}
      <div className="dark:border-gray-700 flex gap-6 items-center border-b pb-3">
      ...
      {sortedComments.length > 0 ? (
        ...
        <div className="text-center py-12">
          <p className="">No comments yet. Be the first to share your thoughts!</p>
        </div>
      )}
    </div>
  )
