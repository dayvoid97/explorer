...
export default function ChronologyCard(props: ChronologyCardHydrated) {
  ...
  return (
    <article
      className="relative overflow-hidden rounded-2xl bg-white/40 backdrop-blur-xl border border-white/30 p-6 transition-all duration-500 hover:shadow-xl hover:shadow-black/10 hover:scale-[1.02] max-w-sm mx-auto flex flex-col"
    ...
    >
      ...
      <div className="relative z-10">
        <Link href={`/chronoW/${id}`} className="block space-y-3">
          <h3 className="text-xxl font-bold text-gray-800 line-clamp-2 transition-colors leading-tight">
            {name}
          </h3>
        ...
        {categories.length > 0 && (
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            {categories.length > 3 && (
              <span className="text-xs text-gray-400 px-2 py-1">+{categories.length - 3} more</span>
            )}
          </div>
        )}
