      ...
      <nav className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            ...
            <span className="animate-gradient-ring absolute -inset-0.5 rounded-full z-[-1] bg-gradient-to-tr from-pink-500 via-blue-500 to-purple-500 opacity-60 blur-sm" />
            {/* Inner Ring Background to preserve transparency */}
