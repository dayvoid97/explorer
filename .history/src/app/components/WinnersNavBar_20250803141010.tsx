    ...
    >
      <nav className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <Link
            href="/wins"
            className="group px-210 relative inline-flex items-center lg:px-6 py-2.5 text-sm font-semibold text-white bg-black hover:from-blue-700 hover:to-purple-700 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 active:scale-95"
          >
