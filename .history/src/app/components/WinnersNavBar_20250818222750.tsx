        ...
        <nav className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4 mt-6">
            ...
            <div className="flex items-center gap-3 lg:gap-4">
              ...
              <Link
                href="/profile"
                className="flex-shrink-0 p-1  hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
