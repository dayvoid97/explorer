...
const Chronology: React.FC<ChronologyProps> = ({ winId, onChronologyAdded }) => {
  ...
  const handleCreateNew = async () => {
    ...
    try {
      ...
      // Step 2: Attach current win to it
      const res2 = await authFetch(`${API_URL}/gurkha/chronology/${data.id}/add`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ winId }),
      })
    ...
    <>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md w-full mx-4 max-h-[85vh] overflow-y-auto">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. jerseyboy, iamkarma"
                    className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white"
                    disabled={loading}
                  />
                </div>
