...
export default function ChronologyCard(props: ChronologyCardHydrated) {
  ...
  return (
    <article
      className=" bg-[#161616]relative overflow-hidden rounded-2xl backdrop-blur-xl border border-white/30 p-6 transition-all duration-500 hover:shadow-xl hover:shadow-black/10 hover:scale-[1.02] max-w-sm mx-auto flex flex-col"
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
    >
      {/* Theme Background */}
      <div
        className={`absolute bg-[#161616] inset-0 opacity-0 transition-all duration-700 rounded-2xl ${
