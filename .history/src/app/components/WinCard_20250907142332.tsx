...
export default function WinCard({ win }: WinProps) {
  ...
  return (
    <article
      ...
      className="group dark:hover:bg-gray-750 w-full cursor-pointer 
             bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 
             hover:bg-gray-50 transition-all duration-200 px-4 py-4 
             flex flex-col justify-between h-[400px] max-h-[400px] rounded-lg"
    >
      {/* Main Content Area */}
