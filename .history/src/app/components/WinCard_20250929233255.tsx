...
export default function WinCard({ win }: WinProps) {
  ...
  return (
    <article
      ...
      className="relative bg-[#161616] rounded-2xl backdrop-blur-xl p-6 transition-all duration-500 hover:shadow-xl hover:shadow-black/10 hover:scale-[1.02] max-w-sm mx-auto flex flex-col min-h-[800px]"
    >
      {/* Main Content Area */}
      <div className="flex gap-3 sm:gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Text Content */}
          <div className="text-sm sm:text-base text-gray-600 dark:text-gray-300 leading-relaxed mb-3 max-h-[120px] overflow-hidden">
            {state.expanded ? (
