...
const MediaThumbnail = ({
  ...
  const sizeClasses = size === 'large' ? 'w-32 h-24 sm:w-40 sm:h-28' : 'w-16 h-16 sm:w-20 sm:h-20'
...
export default function WinCard({ win }: WinProps) {
  ...
  return (
    <article
      ...
      className="group dark:hover:bg-gray-750 w-full cursor-pointer bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 transition-all duration-200 px-4 py-4"
    >
      {/* Main Content Area */}
      <div className="flex gap-3 sm:gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Title */}
          <h2 className="font-bold text-gray-900 dark:text-white text-base sm:text-lg leading-tight mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200">
            {win.title}
          </h2>

          {/* Fixed Content Block */}
          <div className="h-100 sm:h-36 flex flex-col">
            {/* Text Content - Flex grow to fill available space */}
              ...
              <div className="text-sm sm:text-base text-gray-600 dark:text-gray-300 leading-relaxed">
                ...
                {!state.expanded && isLong && (
                  <button
                    ...
                    className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium text-sm mt-1"
                  >
                    Show more
                  </button>
                )}
