...
export default function WinCard({ win }: WinProps) {
  ...
  return (
    <article
      ...
      className="group dark:hover:bg-gray-750 w-full cursor-pointer  dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 transition-all duration-200 px-10 py-10"
    >
      {/* Main Content Area */}
