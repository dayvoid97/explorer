        ...
        <div className="mx-auto max-w-7xl px-10 py-10 sm:px-6 lg:px-8">
          ...
          <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="flex-1 flex items-center justify-end space-x-4">
              ...
              <Link
                href="/profile"
                className="hidden md:flex bg-black items-center justify-center rounded-full p-1 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200 ease-in-out"
