...
const SpinWheelBuilder = () => {
  ...
  const [wheelDescription, setWheelDescription] = useState('Enter your wheel description here')
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white">
      <h1 className="text-4xl font-bold text-center mb-8 text-gray-800">SPIN THE WHEEL BUILDER</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col items-center">
          ...
          {/* Description */}
          <div className="w-full bg-black text-white p-4 rounded-lg mb-6">
            <textarea
              value={wheelDescription}
              onChange={(e) => setWheelDescription(e.target.value)}
              className="w-full bg-transparent text-white placeholder-gray-400 resize-none border-none outline-none text-center"
