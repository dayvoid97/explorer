    ...
    <header className="rounded-5xl backdrop-blur-md border-b z-50 sticky top-0 shadow-sm">
      <nav className="rounded-5xl  max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between ">
        ...
        <div className="">
          <Link
            href="/"
            className="padding-2ch  text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black hover:scale-105 transition-transform duration-200"
          >
            FINANCIAL GURKHA
            <sup className="text-[0.5rem] sm:text-xs md:text-sm font-bold dark:text-blue-300 ml-1">
              BETA
            </sup>
          </Link>
          {/* <MastheadInline /> */}
