...
const winners: Winner[] = [
  { name: '$150', color: '#000000ff' },
  { name: '$300', color: '#4ECDC4' },
  { name: '$500', color: '#04007cff' },
  { name: '$600', color: '#165c00ff' },
]
...
const LuckyDraw: React.FC = () => {
  ...
  const [spinSpeed, setSpinSpeed] = useState<number>(4) // duration in seconds
  const [numberOfSpins, setNumberOfSpins] = useState<number>(5) // number of full rotations
          ...
          <div className="flex flex-col items-center space-y-8">
            <div className="relative">
              <svg width="300" height="300" className="drop-shadow-lg">
                ...
                <polygon
                  points="150,290 170,250 130,250"
                  fill="#030202ff"
                  stroke="#fff"
                  strokeWidth="2"
                />
