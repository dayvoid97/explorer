...
const LuckyDraw: React.FC = () => {
  ...
  const exportAsImage = () => {
    ...
    img.onload = () => {
      ...
      // Add overlay image at the top if it exists
      if (overlayImage) {
        const overlayImg = new Image()
        overlayImg.onload = () => {
          // Draw overlay image at the top center
          ...
          // Draw the wheel below the overlay
          ctx.drawImage(img, 250, 150, 300, 300)

          // Add title below overlay but above wheel
          ctx.fillStyle = '#374151'
          ctx.font = 'bold 32px Arial'
          ctx.textAlign = 'center'
          ctx.fillText('Lucky Draw Wheel', 400, 130)
        ...
        // No overlay image, use original layout
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <input
                          ...
                          className="w-full px-3 py-2 bg-white/20 backdrop-blur-sm border border-white/30 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500"
                        />
