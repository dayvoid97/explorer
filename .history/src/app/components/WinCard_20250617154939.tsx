    ...
    >
      ...
      <div className="flex gap-4 items-start">
        ...
        <div className="flex flex-1 items-start gap-4">
          ...
          {/* Media Preview */}
          {Array.isArray(win.mediaUrls) &&
            Array.isArray(win.mimeTypes) &&
            win.mediaUrls.length > 0 &&
            win.mimeTypes.length === win.mediaUrls.length && (
              <div className="w-24 sm:w-28 md:w-32 flex-shrink-0 rounded-md overflow-hidden dark:bg-gray-700 flex items-center justify-center h-24 md:h-28">
                {(() => {
                  const previewUrl = win.mediaUrls[0]
                  const mime = win.mimeTypes[0]
                  ...
                  return <span className="text-xs text-gray-500">Unsupported media</span>
                })()}
              </div>
            )}
        </div>
