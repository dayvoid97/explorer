...
import { classifyExternalLink } from '../hooks/classifyExternalLinks'
import { ExternalLinkInfo } from '../hooks/classifyExternalLinks'
...
export default function PostWinForm() {
  ...
  useEffect(() => {
    if (externalLink.trim()) {
      const { platform, type } = classifyExternalLink(externalLink.trim())
      setExternalPreview({
