    ...
    >
      <nav className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <Link
            href="/wins"
            className="group relative inline-flex items-center px-4 lg:px-6 py-2.5 text-sm font-semibold rounded-full border border-white/20 text-black dark:text-white hover:scale-105 active:scale-95 transition-all duration-300 z-10"
          >
            {/* Glowing Outer Ring */}
            <span className="glow-ring animate-spin-slow absolute inset-[4px] rounded-full z-[-1]" />
