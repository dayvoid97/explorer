...
//   return (
//     <article className="group border-border bg-card hover:border-foreground/60 rounded-2xl border p-4 transition">
//       <Link href={`/chronoW/${id}`}>
//         <h3 className="text-foreground line-clamp-1 text-lg font-semibold">{name}</h3>
...
//           {creator?.pfp ? (
//             <Image src={creator.pfp} alt="" width={18} height={18} className="rounded-full" />
//           ) : (
//             <div className="border-border h-[18px] w-[18px] rounded-full border" />
//           )}
...
//             <div
//               key={i}
//               className="border-border relative h-16 w-full overflow-hidden rounded-lg border"
//             >
//               {/* next/image keeps it crisp */}
//               <Image
//                 src={u}
//                 alt=""
//                 fill
