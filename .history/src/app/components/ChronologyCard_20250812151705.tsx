...
export default function ChronologyCard(props: ChronologyCardHydrated) {
  ...
  return (
    <article
      className="relative overflow-hidden rounded-2xl bg-white/40 backdrop-blur-xl border border-white/30 p-6 transition-all duration-500 hover:shadow-xl hover:shadow-black/10 hover:scale-[1.02] max-w-4xl mx-auto"
