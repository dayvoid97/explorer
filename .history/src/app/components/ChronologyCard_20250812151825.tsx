...
export default function ChronologyCard(props: ChronologyCardHydrated) {
  ...
  return (
    <article
      className="relative overflow-hidden rounded-2xl bg-white/40 backdrop-blur-xl border border-white/30 p-6 transition-all duration-500 hover:shadow-xl hover:shadow-black/10 hover:scale-[1.02] max-w-sm mx-auto h-[550px] flex flex-col"
    ...
    >
      ...
      <div className="relative z-10">
        <Link href={`/chronoW/${id}`} className="block space-y-3">
          <h3 className="text-xl font-bold text-gray-800 line-clamp-2 transition-colors leading-tight">
            {name}
          </h3>
          <p className="text-gray-600 text-sm line-clamp-3 transition-colors leading-relaxed">
            {description}
          </p>
        </Link>
