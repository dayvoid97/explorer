...
export default function Navbar() {
  ...
  return (
    <header className=" rounded-5xl backdrop-blur-md border-b border-gray-200 dark:border-gray-800 z-50 sticky top-0 shadow-sm">
      ...
      {/* Mobile nav modal */}
      {isMobileMenuOpen && (
        <div className="animate-fadeIn fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-start justify-start pt-20 px-6 md:hidden">
          <div className="relative w-full max-w-sm space-y-6 bg-black/80 p-6 rounded-xl border border-gray-700 shadow-xl">
            {/* Close button */}
            <button
