    ...
    <section className="mb-12">
      ...
      >
        {wins.map((win) => (
          <div
            key={win.id}
            className="group relative px-6 py-10 rounded-xl border border-gray-300 dark:border-gray-700 shadow transition-all duration-300 hover:shadow-lg"
          >
            {/* Remove button */}
            <button
              onClick={async (e) => {
              ...
              className="absolute top-3 right-3 text-xs px-2.5 py-1 rounded-md  text-white hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-400"
            >
              Remove
            </button>
