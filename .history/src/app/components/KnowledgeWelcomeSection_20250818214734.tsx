      ...
      <div className="grid md:grid-cols-2 gap-6 items-center">
        <div>
          ...
          <p className="text-neutral-300 mb-4">
            ChronoDUBS is for the WINNERS. It's about WINNING in Life. Chronodubs is about{' '}
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-center gap-2 text-green-400">
              ...
              <span>Learn from WINNER strategies</span>
            </div>
            <div className="flex items-center gap-2 text-blue-400">
              <BookOpen className="w-4 h-4" />
              <span>Study real WINNING trade decisions</span>
            </div>
            <div className="flex items-center gap-2 text-purple-400">
              <Brain className="w-4 h-4" />
              <span>Build WINNING pattern recognition</span>
              <span>Only Ws in the Chat</span>
            </div>
          </div>
        </div>
