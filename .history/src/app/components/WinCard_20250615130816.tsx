  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:gap-4 items-start">
        ...
        {win.previewImageUrl && (
          <div className="w-full mt-4 md:mt-0 md:w-2/5 lg:w-1/3 flex-shrink-0 dark:bg-gray-700 rounded-lg overflow-hidden flex items-center justify-center h-40 md:h-32 lg:h-40">
