...
import { PlusCircle, Menu, X, Clock } from 'lucide-react'
        ...
        <nav className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4 mt-6">
            ...
            <div className="flex items-center gap-2 lg:gap-3">
              ...
              <Link
                href="/chronodubs"
                className="group inline-flex items-center px-3 lg:px-4 py-2.5 text-sm font-semibold rounded-full bg-gradient-to-r from-emerald-600 to-teal-600 text-white hover:from-emerald-700 hover:to-teal-700 transform hover:scale-105 active:scale-95 transition-all duration-200 shadow-lg hover:shadow-xl"
              >
                <Clock className="w-4 h-4 mr-2 group-hover:animate-pulse transition-all duration-300" />
                <span className="hidden lg:inline">ChronoDUBS</span>
              ...
              <Link
                href="/wins"
                className="group inline-flex items-center px-3 lg:px-4 py-2.5 text-sm font-semibold rounded-full bg-gradient-to-r from-blue-600 to-purple-600 text-white hover:from-blue-700 hover:to-purple-700 transform hover:scale-105 active:scale-95 transition-all duration-200 shadow-lg hover:shadow-xl"
              >
                <PlusCircle className="w-4 h-4 mr-2 group-hover:rotate-90 transition-transform duration-300" />
                <span className="hidden lg:inline">DROP IT</span>
              ...
              <Link
                href="/profile"
                className="flex-shrink-0 p-3 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
...
function MobileMenu({ isOpen, onClose }: MobileMenuProps) {
  ...
  const menuItems = [
    ...
    { href: '/chronodubs', label: 'ChronoDUBS', icon: Clock, highlight: false },
