        ...
        <div className="flex-1 flex flex-col items-center">
          <div className="flex flex-col items-center gap-1">
            <div className="flex items-center gap-2">
              <span className="text-2xl sm:text-3xl font-extrabold select-none tracking-wide">
                ONLY WS IN THE CHAT
              </span>
            ...
            <Link
              href="/"
              className="text-lg sm:text-xl font-black tracking-wide hover:scale-105 transition-transform duration-200"
            >
              FINANCIAL GURKHA
              <sup className="ml-1 text-xs font-semibold text-blue-400">BETA</sup>
            </Link>
