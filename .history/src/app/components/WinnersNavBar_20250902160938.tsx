          ...
          <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="flex-grow text-center">
              <div className="md:block">
                ...
                <p className="text-s font-extrabold  mt-0.5">
                  a{' '}
                  <a href="/" className="hover:underline underline">
                    financial gurkha
                  </a>{' '}
                  production
                </p>
            ...
            <div className="flex-1 flex items-center justify-end space-x-4">
              ...
              <Link
                href="/profile"
                className="hidden md:flex bg-black items-center justify-center  p-1 hover:bg-green-500 dark:hover:bg-green-800 transition-colors duration-200 ease-in-out"
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-[60] md:hidden">
          ...
          >
            ...
            <nav className="p-4 space-y-2 bg-black">
              <Link
                href="/profile"
                onClick={closeMobileMenu}
                className="text-white-700 flex items-center px-4 py-3 text-base font-medium dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
              >
                <Image
                  src={pippin}
                  alt="Profile"
                  width={32}
                  height={32}
                  className="rounded-full mr-3 border-2 "
                />
                <p className="text-white">Account</p>
              </Link>

              <Link href="/wins" onClick={closeMobileMenu} className="flex items-center px-4 py-3">
                <PlusCircle height={40} width={40} color="white" />
                <p className="text-white"> POST A DUB</p>
              </Link>
            </nav>
          </div>
        </div>
