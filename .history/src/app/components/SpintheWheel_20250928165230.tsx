                    ...
                    {participants.map((participant, index) => (
                      ...
                      >
                        ...
                        <input
                          ...
                          className="flex-1 px-2 py-2 bg-white/20 backdrop-blur-sm  border-white/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 text-white placeholder-gray-400"
