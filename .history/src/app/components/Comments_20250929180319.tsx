...
export default function Comment({
  ...
  const getThreadingClasses = () => {
    ...
    const borderClasses =
      depth <= 3 ? 'border-l-2 border-gray-200 dark:border-gray-700 bg-[#fff000]' : ''
  ...
  return (
    <div className={getThreadingClasses()} style={getIndentationStyle()}>
      ...
      <article
        className={`rounded-xl bg-white dark:bg-[#111] border border-gray-200 dark:border-gray-700 p-4 transition hover:shadow-sm ${
          isNested ? 'mt-2' : 'mb-4'
