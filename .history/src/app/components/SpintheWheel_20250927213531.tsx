...
const LuckyDraw: React.FC = () => {
  ...
  const getPointerPoints = (): string => {
    switch (pointerPosition) {
      case 'top':
        return '150,10 170,50 130,50'
      case 'bottom':
        return '150,290 170,250 130,250'
      case 'left':
        return '10,150 50,130 50,170'
      case 'right':
        return '290,150 250,170 250,130'
      default:
        return '150,10 170,50 130,50'
    }
  }
          ...
          <div className="flex flex-col items-center space-y-8">
            <div className="relative">
              <svg width="300" height="300" className="drop-shadow-lg">
                ...
                <polygon points={getPointerPoints()} stroke="#fff" strokeWidth="10" />
              </svg>
            </div>
