...
export default function PostWinForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Split text into paragraphs by double line break
      ...
      if (!title.trim() || paragraphArray.length === 0) {
        throw new Error('Please fill out the title and content.')
      }
      ...
      for (const file of mediaFiles) {
        const uploadUrlRes = await fetch('/api/gurkha/wins', {
          method: 'POST',
          headers: {
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          placeholder="Share your W... Use Enter twice to break into paragraphs."
