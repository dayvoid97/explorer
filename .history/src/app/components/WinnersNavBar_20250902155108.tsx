...
export default function WinnersNavbar() {
  ...
  return (
    <>
      {/* Main Header */}
      <div className="sticky top-0 z-50 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm shadow-md">
          ...
          <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="flex-grow text-center">
              <div className="md:block">
                <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white leading-none">
                  ONLY WS IN THE CHAT
                </h1>
