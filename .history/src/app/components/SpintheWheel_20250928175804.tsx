                          ...
                          <div className="flex items-center gap-3 p-3 bg-white/5 rounded-lg border border-white/10">
                            <div className="flex items-center gap-2">
                              <input
                                ...
                                className="w-10 h-10 rounded-full border-2 border-white/30 cursor-pointer bg-transparent"
                            ...
                            <input
                              ...
                              value={textColor}
                              onChange={(e) => setTextColor(e.target.value)}
                              className="flex-1 px-3 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 text-white placeholder-gray-400"
                              placeholder="#ffffff"
                            />
                          </div>
