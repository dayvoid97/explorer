                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <input
                          ...
                          className="w-full px-3 py-2  backdrop-blur-sm border border-white/30 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500"
                        />
