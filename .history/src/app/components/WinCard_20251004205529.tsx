...
export default function WinCard({ win }: WinProps) {
  ...
  return (
    <article
      ...
      className="relative w-full max-w-sm bg-[#161616] rounded-2xl backdrop-blur-xl p-6 transition-all duration-500 hover:shadow-xl hover:shadow-black/10 hover:scale-[1.02] flex flex-col"
    >
      {/* Main Content Area */}
