...
export default function PostWinForm() {
  ...
  return (
    ...
    >
      ...
      <div className="space-y-2">
        <label className="text-sm font-medium  ">WRITE YOUR W STORY</label>
        <textarea
          rows={10}
          value={content}
          onChange={(e) => setContent(e.target.value)}
          placeholder="Write freely. Use Enter twice to start new paragraphs."
          className="w-full px-4 py-10 rounded-md bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
        />
      </div>
