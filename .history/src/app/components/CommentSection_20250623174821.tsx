...
export default function CommentSection({ winId }: { winId: string }) {
  ...
  return (
    <div className="mt-12 space-y-8">
      ...
      {confirmDeleteId && (
        <div className="bg-opacity-100 fixed inset-0 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-200 rounded-lg shadow-xl p-6 w-full max-w-sm text-center">
