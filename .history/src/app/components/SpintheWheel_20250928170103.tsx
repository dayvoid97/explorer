    ...
    <div className="min-h-screen">
      <div className="relative z-10 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-2 bg-black">
            <div className="xl:col-span-2 flex flex-col items-center space-y-8">
              <div
                className={`relative p-8 backdrop-blur-lg rounded-3xl shadow-2xl ${
                  backgroundImage ? 'bg-white/10 border border-white/20' : 'bg-transparent'
                }`}
              >
                {backgroundImage && (
                  <div
