          ...
          >
            ...
            <nav className="p-4 space-y-2">
              <Link
                href="/profile"
                onClick={closeMobileMenu}
                className="flex items-center px-4 py-3 text-base font-medium text-gray-700 dark:text-gray-300 rounded-lg hover:bg-green-100 dark:hover:bg-green-800 transition-colors"
              >
                <Image
                  src={pippin}
                  alt="Profile"
