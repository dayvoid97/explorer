    ...
    <section className="bg-black text-center py-20 px-6">
      <div className="text-6xl sm:text-7xl font-extrabold">
        <h1 className="leading-tight">
          <span className="bg-gradient-to-r from-blue-900 to-white bg-clip-text text-transparent">
            financial
          </span>{' '}
      ...
      <div className="text-white-800 mt-4 text-sm sm:text-base space-x-4 tracking-wide">
