      ...
      <div className="px-5 py-8 sm:px-8">
        ...
        {step === 'desk' && (
          <div>
            <h3 className="text-2xl font-bold" style={{ fontFamily: 'Georgia, serif' }}>
              Done reading? Place your next order.
            </h3>
            <p className="mt-2 text-sm font-light text-white/60">
              Pick a desk. The house fills the order.
            </p>
            <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {DESKS.map((d) => (
                ...
                >
                  <p
                    className="font-mono text-xs uppercase tracking-[0.2em] transition group-hover:text-[#C9A24B]"
                  >
                    {d.label}
                  </p>
        ...
        {step === 'filled' && pick && (
          <div>
            ...
            <Link href={`/blog/${pick.slug}`} className="group mt-5 grid gap-6 sm:grid-cols-[200px_1fr]">
              {pick.image && (
              ...
              <div>
                ...
                <p className="line-clamp-2 pt-2 text-sm font-light text-white/60">{pick.subtitle}</p>
                <p
