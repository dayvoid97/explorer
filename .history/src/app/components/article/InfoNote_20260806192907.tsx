  ...
  return (
    <span ref={wrapRef} className="relative inline-block align-baseline">
      ...
      <span
        id={panelId}
        role="note"
        className={`z-500 absolute left-1/2 top-[calc(100%+0.6em)] block w-[min(20rem,78vw)] -translate-x-1/2 rounded-sm border p-3 text-left shadow-xl transition-all duration-150 ${
          open
            ? 'visible opacity-100'
