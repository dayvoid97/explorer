...
export default function WinnersNavbar() {
  ...
  className={`mt-2 text-xs sm:text-sm font-semibold tracking-wide text-center transition-colors duration-300 ${
    scrolled ? (isLight ? 'text-black' : 'text-white') : (isLight ? 'text-white' : 'text-white')
  }`}
>
  by Financial Gurkha
</a></div>
        ...
        >
          ...
          >
            ...
            <div className="space-y-3 text-white pt-2">
              <a href="/about" className="block text-base font-medium transition hover:text-blue-400 py-2.5">
                About
              </a>
              <a href="/profile" className="block text-base font-medium transition hover:text-blue-400 py-2.5">
                Account
              </a>
              <a href="/wins" className="block text-base font-medium hover:text-blue-400 transition py-2.5">
                PRESS IT
              </a>
              <a
                href="/winners"
