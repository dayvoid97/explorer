...
export default function WinCard({ win }: WinProps) {
  ...
  return (
    <article
      ...
      className="mt-10 mb-10 relative bg-[#161616] rounded-2xl backdrop-blur-xl p-2 transition-all duration-500 hover:shadow-xl hover:shadow-black/10 hover:scale-[1.02] max-w-sm mx-auto flex flex-col"
    >
      {/* Main Content Area */}
