...
export default function WinnersNavbar() {
  ...
  return (
    <>
      <header
        className={`sticky top-0 z-50 bg-transparent  mb-20  shadow-sm ${
          scrolled ? 'backdrop-blur-md shadow-sm' : 'backdrop-blur-md shadow-sm'
        }`}
      >
        <nav className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="h-50 flex items-center justify-between mt-10 lg:h-20">
            {/* Left - Logo Section */}
