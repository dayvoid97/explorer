      ...
      <nav className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          >
            ...
            <span className="absolute -inset-[2px] rounded-full border-transparent z-[-1]">
              <span className="animate-rotate-border absolute inset-0 rounded-full bg-[conic-gradient(from_0deg,_#ff6ec4,_#ffc3a0,_#ff6ec4)]" />
            </span>
