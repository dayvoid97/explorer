...
export default function ChronologyCard(props: ChronologyCardHydrated) {
  ...
  return (
    <article
      className="relative bg-[#161616] overflow-hidden rounded-2xl backdrop-blur-xl border border-white/30 p-6 transition-all duration-500 hover:shadow-xl hover:shadow-black/10 hover:scale-[1.02] max-w-sm mx-auto flex flex-col"
    ...
    >
      ...
      <div className="text-[#eff0f2] relative z-10">
        <Link href={`/chronoW/${id}`} className="block space-y-3">
          ...
          <p className="text-l line-clamp-3 transition-colors leading-relaxed text-[#eff0f2]">
            {description}
          </p>
        </Link>
