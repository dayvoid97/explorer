...
export default function Masthead() {
  ...
  return (
    <section className="relative bg-black text-center py-20 px-6 space-y-6">
      {/* Title */}
      ...
      <div className="flex-col">
        <p className="text-white/50 text-xs tracking-widest uppercase mt-4">
          ...
          <button
            ...
            className="absolute bottom-6 right-6 p-2 rounded-full bg-white text-black hover:bg-gray-200 transition"
