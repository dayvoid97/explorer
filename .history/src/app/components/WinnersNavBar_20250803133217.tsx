    ...
    >
      <nav className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <Link
            href="/wins"
            className="inline-flex items-center px-3 py-1.5 text-sm font-medium bg-blue-600 hover:bg-blue-700 text-white rounded-full transition shadow-md"
          >
            <PlusCircle className="w-4 h-4 mr-1" /> Drop Intel / Dub
          </Link>
