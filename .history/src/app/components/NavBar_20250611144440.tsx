  ...
  return (
    <header className="rounded-5xl backdrop-blur-md border-b z-50 sticky top-0 shadow-sm">
      ...
      {isMobileMenuOpen && (
        ...
        >
          <div
            className="animate-fadeIn relative w-full max-w-sm  mx-6 bg-black/90 p-6 rounded-xl border border-gray-700 shadow-xl"
...
function NavLinks() {
  return (
    <>
      <Link href="/profile" className="block text-xl font-medium transition">
        Account
      </Link>
      <Link href="/wins" className="block text-xl font-medium hover:text-blue-400 transition">
        Press It
      </Link>
      <Link
        href="/winners"
