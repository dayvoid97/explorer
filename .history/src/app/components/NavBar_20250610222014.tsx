...
export default function Navbar() {
  ...
  return (
    <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 z-50 sticky top-0 rounded-2xl shadow-sm">
