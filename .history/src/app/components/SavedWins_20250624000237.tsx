        ...
        {wins.map((win) => (
          ...
          >
            ...
            <button
              ...
              className="absolute top-10 right-3 text-xs px-2.5 py-1 rounded-md text-gray-600 dark:text-gray-400 bg-gray-100 dark:bg-gray-700 hover:bg-red-600 dark:hover:bg-red-800 hover:text-white focus:outline-none focus:ring-2 focus:ring-red-400"
            >
              Remove
            </button>
