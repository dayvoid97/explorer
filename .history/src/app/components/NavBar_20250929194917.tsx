    ...
    <header className="rounded-5xl backdrop-blur-md border-b z-50 sticky top-0 shadow-sm">
      <nav className="rounded-5xl  max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between ">
        ...
        <div className="items-center justify-center ">
          <Link
            href="/"
            className="padding-1ch text-xl sm:text-2xl md:text-3xl lg:text-4xl font-medium hover:scale-105 transition-transform duration-200"
            style={{
          ...
          >
            Financial Gurkha
            <sup className="text-[0.5rem] sm:text-xs md:text-sm font-bold dark:text-blue-300 ml-1 text-[#7b777a] ">
              BETA
            </sup>
          </Link>
          {/* <MastheadInline /> */}
