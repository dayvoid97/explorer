...
export default function PostWinForm() {
  ...
  return (
    <form
      ...
      className="dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-lg p-8 space-y-6 transition-all"
    >
      <h2 className="text-3xl font-bold">Post Your W</h2>
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          required
          className="w-full px-4 py-2 rounded-md dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          placeholder="Write freely. Use Enter twice to start new paragraphs."
          className="w-full px-4 py-3 rounded-md bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500"
        />
      </div>
