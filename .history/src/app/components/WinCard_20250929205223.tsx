    ...
    >
      ...
      <div className="flex gap-3 sm:gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {/* Title */}
          <h2
            className="font-bold text-gray-900 dark:text-white text-base sm:text-lg leading-tight mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-200"
            style={{
