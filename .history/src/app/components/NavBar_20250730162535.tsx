    ...
    <header className="rounded-5xl backdrop-blur-md border-b z-50 sticky top-0 shadow-sm">
      <nav className="rounded-5xl max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
        ...
        <div className="flex-1 flex justify-center">
          <Link
            href="/"
            className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-black text-center hover:scale-105 transition-transform duration-200 tracking-wider"
          >
            FINANCIAL GURKHA
        ...
        <div className="flex md:hidden w-10"></div>
      </nav>
