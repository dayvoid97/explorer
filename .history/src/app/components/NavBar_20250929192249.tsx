...
export default function Navbar() {
  ...
  return (
    <header className="rounded-5xl mix-blend-mode backdrop-blur-md border-b z-50 sticky top-0 shadow-sm">
      <nav className="rounded-5xl max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between mix-blend-multiply">
        {/* Mobile menu button */}
