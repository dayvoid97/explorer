    ...
    <section className="mb-12">
      ...
      >
        {wins.map((win) => (
          <div
            key={win.id}
            className="group relative px-6 py-20 rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 shadow transition-all duration-300 hover:shadow-lg"
          >
            {/* Remove button */}
            <button
              onClick={async (e) => {
