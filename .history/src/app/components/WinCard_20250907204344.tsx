...
export default function WinCard({ win }: WinProps) {
  ...
  return (
    <article
      ...
      className="group  w-full cursor-pointer bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 transition-all duration-200 px-10 py-10"
    >
      {/* Main Content Area */}
