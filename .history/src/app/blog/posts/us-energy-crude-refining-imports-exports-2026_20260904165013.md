...
image: '/spotlight-links-card.png'
author: 'Kanchan'
---

_Disclaimer: This article is for educational purposes only. Trading and investments are subject to volatility, market risks, and macroeconomic shifts that could lead to partial or total loss of capital. All views expressed here and across FinancialGurkha.com are for educational and information-sharing purposes. Viewer discretion is advised. Please consult your financial advisor before making investment decisions. FinancialGurkha.com and its authors assume no liability for financial outcomes._

---

# Introduction

The United States produces more crude oil than any country has ever produced. It is also, right now, running its refineries harder than at almost any point in the last decade, drawing down an emergency reserve that is smaller than it has been since Ronald Reagan's first term, and paying the highest diesel prices in its history.

Those facts are not in tension. They are the same fact, viewed from different angles. This article is an attempt to lay out the whole picture in one place: what the US actually produces, what it refines, what it imports, what it exports, what it holds in storage, and why the most profitable stretch in the history of American refining is producing no new refineries at all.

The numbers below come from three sources. The first is the **EIA Weekly Petroleum Status Report** for the week ending **August 28, 2026**, released Wednesday, September 2. The second is a **Bloomberg Terminal** research session run against the `NRGZ` energy function, specifically the DOE and IEA chart packs and the EIA Table 9 imports and exports breakdown. The third is contemporaneous reporting on the industry's capital-allocation decisions, principally the September 4, 2026 _Wall Street Journal_ piece by Collin Eaton on why owning a refinery has become more profitable than building one.

> 💡 **The one-paragraph version**: US crude production is running at **13.862 million b/d**. Refiners are pulling in **17.496 million b/d** of crude, which is **98.0%** of operable capacity that fell to **18.2 million b/cd** on January 1, 2026. That gap is why a country producing 13.9 million barrels a day still imports **6.77 million b/d** of crude. Commercial crude stocks fell **4.45 million barrels** on the week to **424.46 million**. The SPR is at **286.6 million barrels**, the lowest since 1983. Cushing sits at **22.5 million barrels**, barely above the roughly 20 million barrel level at which the hub stops functioning properly. The diesel crack spread hit a record **$102 a barrel**. And the six largest US refiners made a combined **$24.7 billion** in the second quarter, nearly five times the year-ago figure, while committing to build nothing.

---

## Table of Contents

> - [1. The Inventory Picture: Crude, Cushing, and the SPR](#1-the-inventory-picture-crude-cushing-and-the-spr)
> - [2. Domestic Production and Where It Comes From](#2-domestic-production-and-where-it-comes-from)
> - [3. Imports, Exports, and Why America Still Buys Foreign Crude](#3-imports-exports-and-why-america-still-buys-foreign-crude)
> - [4. Refining: Running Flat Out on a Shrinking Capacity Base](#4-refining-running-flat-out-on-a-shrinking-capacity-base)
> - [5. Prices, Cracks, and Refiner Profits](#5-prices-cracks-and-refiner-profits)
> - [6. Why Nobody Is Building a New Refinery](#6-why-nobody-is-building-a-new-refinery)
> - [7. The Global Balance: IEA Supply and Demand](#7-the-global-balance-iea-supply-and-demand)
...
### 1.2 Cushing, Oklahoma: The Delivery Point Problem
...
The context matters more than the level. Cushing's working storage capacity is roughly **76 million barrels**. The hub's practical operational floor, the point at which tanks and pipe cannot maintain pump suction and the terminal stops working properly, is around **20 million barrels**. In July of this year, Cushing spent multiple consecutive weeks _below_ that line, and the EIA itself published an explainer on tank bottoms in response.
...
### 1.3 The Strategic Petroleum Reserve
...
> ⚠️ **The part that does not show up in the barrel count**: The SPR stores crude in solution-mined salt caverns along the Gulf Coast, and those caverns were not engineered for repeated rapid cycling. The GAO has flagged that as of December 2025, **more than a quarter** of SPR inventory was not available for drawdown at all, due to a combination of construction outages and cavern outages. Analysts have separately warned that the pace of withdrawal itself risks damaging cavern integrity. The headline number of 286.6 million barrels therefore overstates what could actually be delivered in a genuine emergency.

### 1.4 Products: Gasoline and Distillate
...
Pulling **EIA Crude by State** off the Bloomberg terminal gives lower-48 production of approximately **13.4 million barrels a day**, with the balance to the national total coming from Alaska. The state and area detail recorded in the research session:
...
> 📝 **A note on regional classification**: The terminal session recorded the Midwest as the region with the highest crude production and the Gulf states as the region with the highest crude exports. The export point is unambiguous and confirmed below. The production point depends entirely on which regional grouping is applied, since Texas and federal offshore Gulf of Mexico volumes sit in PADD 3 on the EIA's standard classification, which would make the Gulf Coast the largest producing district by a wide margin. Readers should treat the state-level table above as the authoritative cut.

---

## 3. Imports, Exports, and Why America Still Buys Foreign Crude

This is the section that confuses people most, so it is worth doing carefully. The United States is a **net exporter of petroleum** and simultaneously **imports 5.8 to 6.8 million barrels of crude oil every single day**. Both statements are true and neither is a contradiction.
...
Note the zeros in the two SPR import lines. Nothing is going back into the reserve. The refill has not started.
...
Total exports of **11.896 million b/d** against total imports of **7.819 million b/d** give **net exports of roughly 4.08 million b/d**. The US is a substantial net supplier of energy to the rest of the world.
...
**Second, and more fundamentally, quality mismatch.** The American refining fleet was built over decades to run **heavy sour crude** from Venezuela, Mexico, Canada, and the Middle East. Gulf Coast refiners in particular invested tens of billions of dollars in coking and hydrotreating units specifically designed to break down dense, high-sulphur barrels. What the shale revolution delivered instead was **light sweet crude** with an API gravity those units cannot economically process at full rates. A Gulf Coast coker fed nothing but Permian light sweet is an expensive asset running below its design value. So the US exports light sweet crude to refineries abroad that want it, and imports heavy sour crude that its own refineries were built to consume. This is the single most misunderstood fact in American energy.
...
Crude runs are up **627,000 b/d year over year**, an increase equivalent to adding two mid-sized refineries to the national fleet in twelve months, achieved entirely by running the existing fleet harder. The _Wall Street Journal_ reports that US refineries have been operating at over **97% of collective capacity** in recent weeks, near their highest rate in about eight years.
...
So capacity fell about 1% in a year in which crude runs rose about 3.7%. That is the entire story of the 98% number in two sentences.
...
**The Midwest is running above 100%.** This is not an error. Reported utilization is measured against _calendar day_ capacity, which builds in an allowance for scheduled and unscheduled downtime. A refinery running hard with no maintenance can exceed its calendar-day rating for a period; the relevant ceiling is _stream day_ capacity, which is higher. What a 103% print actually tells you is that PADD 2 refiners have suspended maintenance to chase the diesel crack.
...
| Rank  | Company                      | Notes                                            |
| :---- | :--------------------------- | :----------------------------------------------- |
| **1** | **Marathon Petroleum (MPC)** | Largest US refiner by capacity                   |
...
PBF Energy, while smaller, is a significant independent and was among the companies at the White House meeting this week.
...
### 5.2 The Diesel Crack: The Real Story
...
1. **The Iran war**, now six months old, has disrupted Middle Eastern middle-distillate supply and Strait of Hormuz flows.
2. **China has slowly stopped exporting refined products**, removing a marginal supplier that had been balancing the Asian market.
3. **Russian refining capacity** has been degraded by the conflict.
4. **US distillate inventories** are roughly 9% below year-ago levels with winter approaching.
5. **Global refining capacity has been shrinking** for structural reasons discussed in the next section.
...
1. **The US produces 13.862 million b/d of crude and refines 17.496 million b/d.** That 3.63 million b/d gap, plus a fleet configured for heavy sour crude while the shale patch produces light sweet, is the entire explanation for why the world's largest oil producer imports 6.77 million b/d.

2. **Refinery utilization is 98.0% against a capacity base that shrank 250,000 b/cd in 2025** to 18.2 million b/cd. Crude runs are up 627,000 b/d year over year. Every barrel of incremental throughput has come from running harder, not from building more.

3. **The Strategic Petroleum Reserve is at 286.6 million barrels, the lowest since March 1983**, after a 39 million barrel drawdown in nine weeks and roughly 352 million barrels over four years. More than a quarter of what remains was not available for drawdown as of December 2025 due to cavern and construction outages, so the deliverable reserve is materially smaller than the headline.

4. **Cushing at 22.5 million barrels is about 2.5 million barrels above the level at which the WTI delivery hub stops working properly**, and it spent weeks below that line in July.

5. **The diesel crack spread hit a record $102 a barrel.** Retail diesel is $5.599 a gallon, up $1.87 year over year. The six largest US refiners earned $24.7 billion in Q2, roughly five times the year-ago figure.
...
7. **The binding constraint on American energy is not oil in the ground. It is the capacity to turn it into fuel**, and that constraint is getting tighter by roughly 1% a year while demand for the products, particularly middle distillates, does not.
...
**Reporting.** Detail on the White House meeting, refiner capital allocation, the Auers capacity estimate, the Baytown and Pascagoula projects, the America First Refining proposal, and executive commentary is drawn from Collin Eaton, "Owning a Refinery Is More Profitable Than Building One," _The Wall Street Journal_, September 4, 2026, page B9.
...
- [US National Accounts, Fiscal Deficits, and Housing: A Macro Primer](/blog/us-national-accounts-housing-deficit-macro-primer)
- [USA Net Investment Position and Global Capital Flows](/blog/usa-net-investment-position)
