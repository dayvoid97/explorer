...
image: '/fed-hikes-rates-september-fomc.jpeg'
author: 'Kanchan'
---
...
- **The Fed raised rates by 25 basis points**, its first hike of this cycle under Chair Kevin Warsh.
- **The vote was unanimous.** The three July dissenters — Hammack, Kashkari, Logan — are now simply the majority.
- **The economy is described as strong on every axis**: solid growth, resilient spending, strong productivity, robust investment, a balanced labor market.
- **The statement no longer names energy or the Middle East.** It now says "geopolitical developments." That is a deliberate narrowing of the Fed's excuse set.
- **The Implementation Note moves every administered rate up in lockstep**, keeps the $160 billion ON RRP cap, and keeps the Fed buying Treasury bills to hold reserves ample. **The Fed is tightening the price of money, not the quantity of reserves.**
