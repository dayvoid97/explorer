...
I personally trade **Gold micro futures** <Info label="Micro futures">A futures contract is an agreement to buy or sell an asset at a set price on a future date, and it is leveraged — you post a fraction of the contract value as margin, so gains and losses are magnified against the cash you put up. Micro contracts are simply smaller versions of the standard contract. They track the same price with the same volatility, but each point move is worth far less in dollars, which is what makes them usable on a small account without a single bad day wiping it out.</Info> via **TopStep Prop Trading** (no commission earned by me; this article is not an endorsement).
