...
date: '08/06/2026'
title: "Sandisk's Gross Margin Went From 26% to 85% in One Year: Inside the Most Violent Earnings Turnaround of the AI Era"
...
image: '[/sndk-2026/sndk-2026-hero.jpg](https://www.sandisk.com/content/dam/sandisk/en-us/assets/products/usb-flash-drives/extreme-pro-flash-drive-usb-c/gallery/extreme-pro-flash-drive-usb-c-right.png.wdthumb.1280.1280.png)'
author: 'Kanchan'
---
...
4. **Consumer revenue fell 32% sequentially.** Supply is being allocated away from retail toward the highest bidder. That is a deliberate choice, and it is the clearest evidence of scarcity in the report.
...
- [Sandisk's Gross Margin Went From 26% to 85% in One Year](#sandisks-gross-margin-went-from-26-to-85-in-one-year)
  ...
  - [Consumer Is Being Sacrificed, On Purpose](#consumer-is-being-sacrificed-on-purpose)
...
"Edge" — embedded and client storage, including the drives inside laptops, phones and increasingly AI-capable devices — is still the largest segment at $12.16 billion and grew 195%. The AI story is not confined to the datacenter; on-device inference needs local storage too.

## Consumer Is Being Sacrificed, On Purpose

Now the number nobody will highlight, and the one that tells you the most about market conditions.

**Consumer revenue fell 32% sequentially and 5% year over year**, to $556 million — in a quarter when total revenue rose 51%.

Consumer is the retail business: memory cards, USB drives, the Sandisk-branded products in the shop. Demand for those did not collapse. What happened is that Sandisk redirected scarce wafer supply toward datacenter and edge customers paying materially higher prices.

This is an allocation decision, and it is the single most reliable indicator of genuine scarcity in the entire release. A company with spare capacity serves every customer. A company choosing which customers to disappoint is a company with none. Retail buyers should expect card and drive prices to keep climbing, because the economics of selling that same silicon to a hyperscaler are now overwhelming.
...
**3. Supply is coming.** Nothing draws capacity like 85% gross margins. Samsung, SK Hynix, Micron, Kioxia and YMTC are all watching the same prices. Fab and capacity decisions take 18–24 months to land, which is precisely the horizon over which today's economics get competed away. Every memory upcycle has ended the same way: with capacity that was commissioned at the top arriving into a softer market.

**4. Customer concentration and prepayment risk.** Ten NBM agreements is a small number of relationships carrying an enormous amount of revenue, and hyperscaler capex plans can change quickly. Prepayments also mean some future revenue has already been collected — a headwind to reported growth when those contracts deliver.

**5. Receivables and working capital.** Accounts receivable grew twice as fast as revenue. Refund liabilities rose from $126 million to $1.5 billion. Neither is alarming in a quarter this size, but both are lines where a pricing peak first shows up as a collections problem.

**6. Governance and disclosure gaps.** An undisclosed $1.777 billion equity portfolio producing an $804 million gain is unusual for a semiconductor manufacturer. It is not a red flag on this evidence — but it is worth understanding what it is before treating it as recurring.
...
Consumer revenue fell 32% sequentially to $556 million because Sandisk allocated constrained NAND supply toward higher-priced datacenter and edge customers. It is a deliberate allocation decision and a strong indicator of genuine supply scarcity rather than weak retail demand.
