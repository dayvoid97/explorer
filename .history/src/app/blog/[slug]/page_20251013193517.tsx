...
function injectAdsIntoContent(content: string): string {
  ...
  let adCount = 0
  if (wordCount > 1500) adCount = 3
  else if (wordCount > 1000) adCount = 2
  else if (wordCount > 500) adCount = 1
...
export default async function BlogArticlePage({ params }: { params: { slug: string } }) {
  ...
  return (
    <main className="max-w-3xl mx-auto p-8">
      <Link href="/blog" className="inline-flex items-center  hover:text-gray-900 mb-8 transition">
