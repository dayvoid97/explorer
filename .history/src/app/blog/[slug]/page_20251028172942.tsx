...
const components = {
  ...
  a: (props: any) => (
    <a
      className="inline-block px-4 py-2 bg-green-800 text-white font-bold rounded-lg shadow-sm transition-all duration-200 hover:bg-green-700 hover:scale-105 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-green-500"
      {...props}
    />
  ),
    ...
    <main className="max-w-3xl mx-auto p-8 ">
      ...
      <article className="prose prose-lg dark:prose-invert max-w-none mt-8">
        <MDXRemote
          ...
          components={{ ...components, AdSenseAd }}
          options={{
            mdxOptions: {
