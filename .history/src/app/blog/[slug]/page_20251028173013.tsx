...
const components = {
  ...
  a: (props: any) => (
    <a
      className="inline-block px-2 py-1 bg-green-800 text-white  rounded-lg shadow-sm transition-all duration-200 hover:bg-green-700 hover:scale-105 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-green-500"
      {...props}
    />
  ),
