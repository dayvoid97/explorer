...
export default function NepalHighlight() {
  return (
    ...
    >
      ...
      <p className="mt-6 text-lg md:text-2xl font-semibold text-gray-200 max-w-2xl mx-auto">
        To the global community, please search about Nepal and Gen Z Protest across social media and
        internet. It is important for the world to know the shameless government of Nepal
