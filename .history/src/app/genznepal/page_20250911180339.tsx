      ...
      <section className="flex flex-col md:flex-row items-center justify-center gap-8 p-6 bg-black">
        ...
        >
          ...
          <p className="mt-6 text-lg md:text-2xl font-semibold text-gray-200 max-w-2xl">
            ...
            and the internet. The shameless government of Nepal slaughtered their own kids and
            grandkids—let the world know.
          </p>
        </motion.div>
      ...
      <header className="bg-black text-white py-8">
        <div className="max-w-4xl mx-auto px-6">
          <h1 className="text-3xl md:text-4xl font-bold text-center">
            SHAME ON YOU, GOVERNMENT OF NEPAL
          </h1>
        ...
        <div className="max-w-4xl mx-auto px-6 mt-8">
          ...
          <p className="text-lg text-center mt-2">
            SHAME on you, major outlets for portraying the Gen-Z protest of Nepal as a protest
            against a social media ban.
          </p>
        </div>
      </header>

      <main className="max-w-4xl mx-auto px-6 py-12 bg-white text-black rounded-lg mt-8">
        <section className="mb-16">
          <h2 className="text-2xl md:text-3xl font-bold mb-6">
            19 people killed in protests against corruption
          </h2>
