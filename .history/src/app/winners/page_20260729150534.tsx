...
const ONLYDUBS_URL = '/media-storage'
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
        ...
        <header className="mb-16 text-center">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto" style={grotesk}>
            A hall of fame for the biggest Ws of life. Builders, traders, teachers, parents, and one
            city. Only dubs in the chat.
          </p>
        </header>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {WINNERS.map((w, i) => (
            ...
            >
              ...
              <p className="text-sm uppercase tracking-wider text-gray-400 mb-4" style={grotesk}>
                {w.tag}
              </p>
