...
export default function WinnersPage() {
  ...
  return (
    <div style={{ scrollBehavior: 'smooth' }}>
      ...
      {/* Add container wrapper with top margin and max-width */}
      <div className="w-full max-w-7xl mx-auto mt-6">
        {loading && wins.length === 0 ? (
          ...
          <div className="bg-[#3b3a3c] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-2">
            {wins.map((win) => (
        ...
        {/* Load more button - now inside container */}
        {hasMore && wins.length > 0 && !loading && (
          <div className="flex justify-center mt-8 bg-[#3b3a3c]">
            <button
        ...
        {/* End of Wins Message - now inside container */}
        {!hasMore && !loading && wins.length > 0 && (
          <div className="text-center py-8 bg-[#3b3a3c]">
      ...
      {/* Scroll to top button - stays outside container */}
      {showScrollTop && (
        <button
          onClick={scrollToTop}
