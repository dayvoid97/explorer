...
export default function WinnersPage() {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      { threshold: 1.0 } // fully in view before triggering
    )
  ...
  }, [loadMoreButtonRef, loadingMore, hasMore])
          ...
          <button
            ...
            className={`px-8 py-3 rounded-lg font-semibold transition-all duration-200 transform hover:scale-105 ${
              loadingMore
                ...
                : ' hover:bg-gray-800 shadow-md hover:shadow-lg dark:bg-white dark:text-black dark:hover:bg-gray-200'
            }`}
          >
            {loadingMore ? (
