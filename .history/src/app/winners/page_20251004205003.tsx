  ...
  return (
    <div className="bg-[#3b3a3c] flex-grow" style={{ scrollBehavior: 'smooth' }}>
      ...
      {loading && wins.length === 0 ? (
        ...
        <div className=" bg-[#3b3a3c] mt-10  grid sm:grid-cols-2 md:grid-cols-3 gap-5 justify-center">
          {wins.map((win, index) => (
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="bottom-6 right-6 z-50 p-3 rounded-full bg-black text-white dark:bg-white dark:text-black shadow-lg hover:scale-110 transition-all duration-200 transform hover:shadow-xl backdrop-blur-sm"
