...
export default function WinDetailPage() {
  ...
  const { id: winId } = useParams() as { id: string }
        ...
        {win.externalLink?.url && (
          <div className="rounded-xl overflow-hidden border dark:border-gray-700 bg-gray-100 dark:bg-gray-800 p-4 space-y-3 text-center">
            ...
            {/* <a
              ...
              className="inline-block px-4 py-2 text-sm font-semibold rounded-md bg-blue-600 text-white hover:bg-blue-700 transition"
            >
              {win.externalLink.type === 'channel' ? 'Visit Channel →' : 'Open Content →'}
            </a> */}
          </div>
        )}
