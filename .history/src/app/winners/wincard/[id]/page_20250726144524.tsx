...
export default function WinDetailPage() {
  ...
  return (
    <div className="min-h-screen px-4 py-12 max-w-4xl mx-auto space-y-10 bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
      {/* Sticky Title/Header */}
      <div className="sticky top-0 z-30 bg-white/95 dark:bg-gray-900/95 border-b border-gray-200 dark:border-gray-800 shadow-sm flex items-center gap-3 py-4 px-2 md:px-4" style={{backdropFilter: 'blur(6px)'}}>
        <button
          onClick={() => router.push('/winners')}
          aria-label="Back to winners"
          className="mr-2 p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-800 transition"
        >
          <span className="text-2xl font-bold">&#8592;</span>
        </button>
        <h1 className="text-2xl md:text-3xl font-bold tracking-tight truncate">{win.title}</h1>
      </div>
