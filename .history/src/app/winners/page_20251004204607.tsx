...
export default function WinnersPage() {
  ...
  return (
    <div className="bg-[#3b3a3c]" style={{ scrollBehavior: 'smooth' }}>
      <Navbar />

      {/* Top reference point for smooth scrolling */}
      <div ref={topRef} className="mt-10 absolute -top-10 min-h-screen" />
      ...
      {loading && wins.length === 0 ? (
        ...
        <div className=" bg-[#3b3a3c]  grid sm:grid-cols-2 md:grid-cols-3 gap-5 justify-center">
          {wins.map((win, index) => (
