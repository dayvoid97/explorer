...
If you wish to delete your account, you may do so via the Strum- Vibe Together App using the "Delete Account" feature in Account Settings or you can send us an email at strum.tips@gmail.com with subject "Account Deletion".
...
7. Content
All content, software, images, text, graphics, logos, and other materials (the "Strum - Vibe Together Content") on the Services are either owned or licensed by us. Except for User Content, no rights are transferred to you.
...
NOTHING IN THESE TERMS SHALL EXCLUDE OR LIMIT OUR LIABILITY FOR LOSSES THAT CANNOT BE LEGALLY EXCLUDED. Subject to applicable law, our total liability is limited to the amount you paid to us in the last 12 months.
...
These Terms and any disputes arising from them will be governed by the laws of the State of California and resolved exclusively in the U.S. District Court for the Central District of California.
...
All content on our Services—including text, graphics, images, logos, audio, video, and software (collectively, the "Content")—is either owned by Strum or licensed to us. Such Content is protected by copyright, trademark, and other intellectual property laws.

3. User-Generated Content
When you submit or upload any content ("User Content") to our Services, you represent and warrant that you either own the content or have all necessary rights and permissions from the original rights holders. By submitting User Content, you grant Strum an unconditional, irrevocable, non-exclusive, royalty-free, worldwide license to use, modify, reproduce, display, and distribute your User Content.
...
The logos, trademarks, service marks, and other brand features (collectively, the "Logos") displayed on our Services are the exclusive property of Strum- Vibe Together or our licensors.

Permitted Use: You may use our Logos solely to identify and promote the Services for non-commercial purposes.
Restrictions: You may not alter, modify, or create derivative works of our Logos.

6. No Warranty; No Liability
All Content—including our Logos and all other intellectual property provided on or through our Services—is provided "as is" without any warranty of any kind.

7. Indemnification
You agree to indemnify, defend, and hold harmless Strum, its affiliates, and their respective officers, directors, employees, and agents from and against any and all claims arising out of or related to any breach of this Copyright and Trademark Policy.

8. Modifications to This Policy
Strum reserves the right to modify or update this Copyright and Trademark Policy at any time. Any changes will be effective immediately upon posting the revised policy on our Services.
