    ...
    <div className="min-h-screen px-4 py-10 max-w-5xl mx-auto space-y-12">
      ...
      <section className="flex items-start gap-6 border rounded-xl p-6 shadow-sm">
        ...
        <div className="space-y-2">
          ...
          {profile.flagged && (
            <div className="bg-red-100 dark:bg-red-900 text-red-700 dark:text-red-200 p-4 rounded-md border border-red-300 dark:border-red-700 mt-4">
              ⚠️ This user has been flagged for violating platform guidelines. Content visibility is
              limited while we review their activity.
            </div>
          )}
      ...
      {/* Wins Section */}
      <section>
        <h2 className="text-xl font-semibold mb-4">Ws</h2>
