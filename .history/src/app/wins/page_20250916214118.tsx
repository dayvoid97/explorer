...
import MyCards, { Card } from '../profile/MyCards'
        ...
        <div className="w-full max-w-7xl">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4">
              Discover Company Cards
            </h3>
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Explore and collect trading cards for your favorite companies. Sign up to create and
          ...
          {/* Use a wrapper to override the heading */}
        ...
        return (
          <div className="w-full max-w-7xl space-y-8">
            ...
            <div className="border-t pt-8">
              <h3 className="text-xl font-semibold mb-6 text-center">Featured Company Cards</h3>
              {/* Override the heading for explore view */}
              <div className="relative">
                <MyCards cards={DEFAULT_CARDS} />
                <style jsx>{`
                  :global(.max-w-7xl h2) {
    ...
    <div className="min-h-screen px-6 py-16 flex flex-col items-center space-y-16 bg-gradient-to-b from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
      ...
      >
        <h1 className="text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">
          Financial Gurkha Card Explorer
        </h1>
        <p className="text-lg text-gray-600 dark:text-gray-300">
          Build and share on knowledge and make money online doing so.
        </p>
      </motion.div>
