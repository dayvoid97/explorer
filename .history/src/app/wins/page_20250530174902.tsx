  ...
  return (
    <div className="min-h-screen px-4 py-12 flex flex-col items-center space-y-12">
      ...
      <div className="text-center space-y-3 max-w-2xl">
        <h1 className="text-4xl">🏆 Celebrate the Wins</h1>
        <p>From personal growth to joyful milestones — this wall celebrates every kind of win.</p>
      </div>
      ...
      <div className="w-full max-w-5xl space-y-6">
        <h2 className="text-center text-2xl">🌟 See what other winners are sharing</h2>
        <WinPreviewGrid />
