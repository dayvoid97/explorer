...
/**
 * Contributing author page.
 *
 * Same job as /about/kanchan: answer "who is behind this and why should the
 * numbers be trusted" for both readers and AI assistants. The difference is
 * that this author's credibility rests on published, citable research rather
 * than on a publication track record here — so the page leads with the papers,
 * links them, and carries the Person + sameAs markup that ties the byline to an
 * identity that exists off this site.
 *
 * Deliberately no portrait: we do not have a licensed photograph of the author,
 * and a broken <Image> or a stock headshot is worse for trust than a monogram.
 */
    ...
    <div className="bg-[#0A0A0A] text-white">
      ...
      <section className="border-t border-white/10">
        <div className="mx-auto grid max-w-4xl gap-10 px-6 py-14 sm:grid-cols-[200px_1fr]">
          <div>
            <div
              className="flex h-[200px] w-[200px] items-center justify-center rounded-full border text-5xl font-black"
