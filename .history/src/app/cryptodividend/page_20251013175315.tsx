  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 rounded-lg mt-8">
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-bold mb-6">
            MACRO CRYPTOS HAVE SEEN A UNPRECEEDENTED RISE IN PRICES
          </h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-blue-50 p-6 rounded-lg text-black">
              <h3 className="text-xl font-semibold mb-3">ETHEREUM</h3>
              <p>Ethereum raised initial funding at less than a dollar per token. </p>
            </div>
            <div className="bg-green-50 p-6 rounded-lg text-black">
              <h3 className="text-xl font-semibold mb-3">SOLANA</h3>
              <p>Solana had humble beginnings and is currently at $200 a pop</p>
            </div>
            <div className="bg-red-50 p-6 rounded-lg text-black">
              <h3 className="text-xl font-semibold mb-3">BNB</h3>
              <p>
                Binance recently crossed $1300. I remember a time when BNB token was trading at less
                than $10 per token
              </p>
            </div>
            <div className="bg-black p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-white">BITCOIN</h3>
              <p className="text-white">
                No explanation needed here. Bitcoin crossed the historic $100,000 per BTC mark
                easily and is hovering around the $110K-$120K range.
              </p>
            </div>
          </div>
        </section>
