      ...
      <div className="flex items-center gap-3 mb-6">
        <div className="flex flex-row gap-2">
          <input
            ...
            className={`border border-gray-300 px-4 py-2 rounded-xl text-sm w-64 transition-all duration-200 ${
              isEditingMeta
          ...
          <input
            ...
            placeholder="Ticker"
            className={`border border-gray-300 px-4 py-2 rounded-xl text-sm w-40 transition-all duration-200 ${
              isEditingMeta
                ? 'bg-white shadow focus:ring-2 focus:ring-blue-500'
                : 'bg-gray-100 text-gray-500 cursor-default'
            }`}
