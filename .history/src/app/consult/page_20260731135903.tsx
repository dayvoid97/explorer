...
export const metadata = {
  ...
  description:
    'Book a one-on-one conversation with Kanchan Sharma of Financial Gurkha on markets, investing, and anything finance — or commission a full intrinsic valuation of any company at $250 per page. Independent research desk, New York City.',
}
  ...
  return (
    <div className="bg-[#0A0A0A] text-white">
      ...
      <section className="mx-auto max-w-5xl px-6 pt-16 pb-14 sm:pt-24">
        ...
        <h1
          className={`${playfair.className} mt-5 text-5xl font-black leading-[1.02] sm:text-6xl`}
        >
          Talk finance with the desk.
        </h1>
        <p className="mt-6 max-w-2xl text-lg font-light leading-relaxed text-white/75">
          Financial Gurkha is an independent research desk run by Kanchan Sharma from New York
          City — a frontier-AI-assisted operation that reads the filings other coverage
          summarizes. If you want a second set of eyes on a company, a portfolio question
          thought through out loud, or a full valuation built to order, this is the door.
        </p>
      ...
      <section className="border-t border-white/10">
        <div className="mx-auto grid max-w-5xl gap-px bg-white/10 px-0 md:grid-cols-2">
          ...
          <div className="bg-[#0A0A0A] px-6 py-14 md:px-10">
            ...
            <a
              href={MEETING_MAILTO}
              className="mt-8 inline-block border px-7 py-3 font-mono text-xs uppercase tracking-[0.25em] transition hover:bg-[#C9A24B] hover:text-black"
          ...
          <div className="bg-[#0A0A0A] px-6 py-14 md:px-10">
            ...
            <p className="mt-4 font-light leading-relaxed text-white/70">
              A full intrinsic valuation of any company — public ticker, private target, or your
              own business. Built from the filings: revenue drivers, margins, reinvestment,
              discount rate, and a defended fair value. The same work as our published DCF
              series, done for you.
            </p>
            <div className="mt-6 border border-white/15 px-5 py-4">
              ...
              <p className={`${playfair.className} mt-1 text-2xl font-bold`}>
                $250 <span className="text-base font-normal text-white/60">per page</span>
              </p>
              <p className="mt-1 text-sm font-light text-white/60">
                A typical valuation runs about four pages — roughly $1,000. Scope agreed up
      ...
      <section className="border-t border-white/10">
        <div className="mx-auto max-w-5xl px-6 py-16">
          ...
          <p className="mt-12 max-w-3xl text-xs font-light leading-relaxed text-white/40">
            Disclaimer: Consultations and commissioned research are educational and analytical
            in nature. Financial Gurkha does not provide personalized investment advice, does
            not manage money, and is not a registered investment adviser. Please consult your
