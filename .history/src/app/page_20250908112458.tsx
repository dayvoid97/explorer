    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-black text-white py-8">
        <div className="max-w-4xl mx-auto px-6">
          <h1 className="text-3xl md:text-4xl font-bold text-center">[YOUR ORGANIZATION NAME]</h1>
          <p className="text-lg text-center mt-2 text-gray-300">[Your tagline or subtitle]</p>
        </div>
      </header>
          ...
          <div className="border-l-4 border-gray-800 pl-6">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4">
                [Write your main solidarity statement here. Express your organization's position,
                condemnation of violence, and support for the victims and their families.]
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
                [Additional paragraphs for your statement. You can include context, your
                organization's values, and calls for justice or accountability.]
              </p>
        ...
        <section className="mb-16 bg-gray-50 p-8 rounded-lg">
          ...
          <div className="text-center">
            <p className="text-gray-700 leading-relaxed mb-6">
              [Space to honor and remember the victims. You can include their names if known, or a
              general tribute to their memory.]
            </p>
            <div className="inline-block bg-black text-white px-6 py-3 rounded">
              <span className="text-lg font-semibold">[Number] Lives Lost</span>
            </div>
          </div>
        </section>
