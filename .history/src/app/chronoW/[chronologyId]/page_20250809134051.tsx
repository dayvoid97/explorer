// Enhanced chronology detail thread UI
'use client'
...
import ThreadItem, { Win } from '@/app/components/ThreadItem'
          ...
          .map((win) => (
            <div key={win.id} className="relative flex gap-4 pl-14">
              ...
              <div className="bg-zinc-900 border border-gray-700 p-5 rounded-xl w-full">
                ...
                {win.signedMediaUrls && win.signedMediaUrls.length > 0 && (
                  <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-4">
                    {win.signedMediaUrls.map((url, idx) => (
                      <img
                        key={idx}
                        src={url}
                        alt={`media-${idx}`}
