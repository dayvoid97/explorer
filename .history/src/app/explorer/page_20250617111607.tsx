...
export default function ExplorerPage(): JSX.Element {
  ...
  return (
    <main className="max-w-6xl mx-auto py-16 px-6">
      ...
      <div className="min-h-screen flex   bg-gray-50 px-4">
        <form onSubmit={handleSubmit} className="flex flex-col gap-6 mb-12 mt-10 w-full max-w-2xl">
          <div className="flex flex-col sm:flex-row gap-4">
            <input
              ...
              className="w-full sm:w-1/2 px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm"
            />
          </div>
          <div className="flex flex-col sm:flex-row gap-4">
            <input
              ...
              className="w-full sm:w-1/4 px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 shadow-sm"
            />
            <input
              type="text"
              value={usernameInput}
              ...
              placeholder="🙋 @kanchan"
              className="w-full sm:w-1/4 px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 shadow-sm"
            />
          </div>
          <button
            type="submit"
