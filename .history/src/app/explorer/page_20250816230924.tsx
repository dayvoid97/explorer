  ...
  return (
    <main className="max-w-6xl mx-auto py-16 px-6">
      ...
      <div className="mt-20 mb-12 text-center">
        <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-2xl p-8 border border-blue-100 dark:border-blue-800/30 shadow-sm">
          <div className="flex flex-col items-center space-y-4">
            <div className="text-4xl mb-2">📚</div>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">
              Discover Chronologies
            </h2>
            <p className="text-gray-600 dark:text-gray-300 max-w-md text-center">
              Explore curated timelines of major events, market movements, and the stories that
              shaped our world.
            </p>
            <button
              onClick={handleDiscoverChronologies}
              className="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-purple-700 transition duration-300 shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98]"
            >
              Get Started →
            </button>
          </div>
