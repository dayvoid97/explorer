...
export default function ExplorerPage(): JSX.Element {
  ...
  return (
    <main className=" mx-auto py-16 px-6">
      <Masthead />
            ...
            >
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500">
                  👤 <span className="font-semibold text-blue-700">@{item.username}</span>
                </p>

                <p className="text-xs text-gray-500 pt-1">
                  🧾 {item.items?.length || 0} items available
                </p>
              </div>

              <div className="absolute top-4 right-4 bg-blue-100 text-blue-600 p-2 rounded-full shadow-md group-hover:scale-110 transition">
