...
export default function ExplorerPage(): JSX.Element {
  ...
  return (
    <main className="max-w-6xl mx-auto py-16 px-6">
      <h1 className="text-gradient text-5xl font-extrabold mb-6 text-center bg-gradient-to-b from-blue-600 via-purple-500 to-pink-500 text-transparent bg-clip-text">
        Financial Gurkha Explorer
      </h1>

      <p className="text-center text-lg text-gray-600 dark:text-gray-400 mb-10">
        Discover global equities, save insights, and build your investor radar.
      </p>
