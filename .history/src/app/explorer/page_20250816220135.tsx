  ...
  return (
    <main className="max-w-6xl mx-auto py-16 px-6">
      ...
      >
        ...
        <div className="w-full flex sm:flex-row items-center gap-4">
          {/* <input
            type="text"
        ...
        <div className="text-xs mt-4 text-gray-500 dark:text-gray-400 flex flex-wrap justify-center gap-3">
