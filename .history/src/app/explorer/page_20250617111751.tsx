      ...
      <form onSubmit={handleSubmit} className="flex  flex-col gap-6 mb-12 mt-10">
        <div className="items-center sm:flex-row gap-4">
          <input
            ...
            className="w-full sm:w-1/2 px-4 py-4 border  rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm"
          />
        </div>
        <div className=" flex-col items-center  sm:flex-row gap-4">
          <input
            ...
            className="w-full sm:w-1/4 px-40 py-3 border  rounded-xl focus:outline-none focus:ring-2 gap-10 focus:ring-green-500 shadow-sm"
          />
          <input
            type="text"
            value={usernameInput}
