      ...
      <form onSubmit={handleSubmit} className="flex  flex-col gap-6 mb-12 mt-10">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full">
          <input
            ...
            className="w-full sm:w-1/4 px-4 py-3 border self-center rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 shadow-sm"
          />
          <input
            type="text"
            value={usernameInput}
            ...
            placeholder="🙋 @kanchan"
            className="w-full self-center sm:w-1/4 px-4 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 shadow-sm"
          />
        </div>
