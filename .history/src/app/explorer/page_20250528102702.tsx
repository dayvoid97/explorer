...
export default function ExplorerPage(): JSX.Element {
  ...
  return (
    <main className="max-w-6xl mx-auto py-16 px-6">
      <h1 className="text-gradient via-black-500 text-5xl font-extrabold mb-6 text-center bg-gradient-to-b from-blue-600 to-pink-500 text-transparent bg-clip-text">
