...
export default function SearchAndAddCard() {
  ...
  return (
    <section className="max-w-screen-md mx-auto px-6 py-10">
      ...
      <h2 className="text-center text-4xl font-extrabold tracking-tight mb-6 leading-snug text-gray-900 dark:text-white">
        {' '}
        {/* Dark mode text */}
        Search & Add a Card
      </h2>
      <form onSubmit={handleSearchAndLaunch}>
        <div className="space-y-8 text-center">
          <div className="rounded-2xl space-y-2 bg-white dark:bg-gray-800 p-6 shadow-md border dark:border-gray-700">
            {' '}
            ...
            <input
              ...
              className="rounded-full border border-gray-300 dark:border-gray-600 px-6 py-3 text-center text-sm w-72 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200"
              required
            />
            <br />
            <input
              ...
              // Dark mode styles for input
              className="rounded-full border border-gray-300 dark:border-gray-600 px-6 py-3 text-center text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200"
            />
