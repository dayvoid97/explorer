        ...
        <div className="space-y-8 text-center">
          <div className="rounded-2xl space-y-2   p-6 shadow-md border dark:border-gray-700">
            ...
            <input
              ...
              // Dark mode styles for input
              className="rounded-full border  px-6 py-3 text-center text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500  dark:bg-gray-700 text-gray-900 dark:text-gray-200"
            />
