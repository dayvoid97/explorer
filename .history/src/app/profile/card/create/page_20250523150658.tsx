...
export default function CreateCardPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/gurkha/companycard/create`, {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="max-w-2xl mx-auto py-10 px-6">
      <h1 className="text-2xl font-bold mb-4">Create a New Company Card</h1>

      <input
        placeholder="Ticker (e.g., NASDAQ:AAPL)"
        value={ticker}
      ...
      <textarea
        placeholder="Write your card bio..."
        rows={4}
        value={cardBio}
