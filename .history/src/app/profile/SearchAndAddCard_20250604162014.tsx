...
export default function SearchAndAddCard() {
  ...
  return (
    <section className="mt-28 max-w-screen-md mx-auto px-6">
      <h2 className="border text-center text-4xl font-extrabold tracking-tight mb-6 leading-snug">
        Search & Add a Card
      </h2>

      <form
        onSubmit={handleSearchAndLaunch}
        className=" border  bg-white shadow-xl border border-gray-200 rounded-3xl px-8 py-10 space-y-10"
      >
