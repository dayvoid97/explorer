      ...
      >
        <div className="space-y-8 text-center">
          <div className="bg-gradient-to-br from-white via-gray-50 to-gray-100 border rounded-2xl px-6 py-8 space-y-2">
            <input
              type="text"
              placeholder="Type to add a card /n How to become an elite soccer player? \nStrength in Consistency "
              value={titleInput}
              ...
              required
            />
            <p className="italic text-sm text-gray-600">E.g. How to be an elite soccer player?</p>
            <p className="italic text-sm text-gray-600">Or: Strength in Consistency</p>
          </div>
