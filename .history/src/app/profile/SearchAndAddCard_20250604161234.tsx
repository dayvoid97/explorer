...
export default function SearchAndAddCard() {
  ...
  return (
    <section className="mt-28 max-w-screen-md mx-auto px-6">
      <h2 className="text-center text-4xl font-extrabold tracking-tight mb-4 leading-snug">
        Search & Add a Card
      </h2>
      ...
      >
        <div className="space-y-6 text-center">
          <div className="bg-gradient-to-br from-white via-gray-50 to-gray-100 border rounded-2xl px-6 py-8">
            <p className="font-semibold text-lg mb-1">Type to add a card</p>
