        ...
        <div className="space-y-8 text-center">
          <div className="rounded-2xl space-y-2   p-6 shadow-md border dark:border-gray-700">
            ...
            <input
              ...
              className=" rounded-full border border-gray-300 dark:border-gray-600 px-6 py-3 text-center w-72 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200"
              required
            />
            <br />
            <input
