...
export default function SearchAndAddCard() {
  ...
  return (
    <section className="mt-28 max-w-screen-md mx-auto px-6">
      ...
      <form onSubmit={handleSearchAndLaunch} className=" border  rounded-3xl px-8 py-10 space-y-10">
        <div className="space-y-8 text-center">
          <div className=" rounded-2xl px-6 py-8 space-y-2">
            <input
              type="text"
              placeholder="Type to add a card"
              value={titleInput}
              onChange={(e) => setTitleInput(e.target.value)}
              className="rounded-full border border-gray-300 text-center text-sm w-72 shadow-sm focus:outline-none focus:ring-2 focus:ring-black"
              required
            />
