...
export default function SearchAndAddCard() {
  ...
  return (
    <section className="max-w-screen-md mx-auto px-6">
      <h2 className=" text-4xl font-extrabold tracking-tight mb-6 leading-snug">
        Search & Add a Card
      </h2>
        ...
        <div className="space-y-8 text-center">
          <div className=" rounded-2xl space-y-2">
            ...
            <input
              ...
              className="rounded-full border border-gray-300 px-6 py-3 text-center text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-black"
            />
            ...
            <div>
              <button
                ...
                className=" hover:bg-white-900 transition disabled:opacity-50"
              >
