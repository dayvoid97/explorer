...
Answer engines will not cite content they cannot fetch, and several respect a named user-agent block over the wildcard. For a publication whose goal is to be _quoted as a source_, this is the whole game.
