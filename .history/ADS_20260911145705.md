...
The sidebar wrapper is `hidden lg:block`, but a hidden element still _mounts_ —
...
| Behaviour                                    | Why                                         |
| :------------------------------------------- | :------------------------------------------ |
| Requested only within ~600px of the viewport | Advertisers bid on _viewable_ impressions   |
